...
class Training(Base):
    ...
    training_status = Column(Integer, autoincrement=False)
    training_space = Column(Integer, autoincrement=False, nullable=False)
    training_free_space = Column(Integer,autoincrement=False, nullable=False)